...
export default function Navbar() {
  ...
  return (
    ...
    >
      ...
      <Link
        href="/#contact"
        className="relative overflow-hidden text-sm font-semibold text-white bg-[#3b82f6] px-6 py-2.5 rounded-full hover:bg-[#2563eb] transition-all hover:scale-105 shadow-[0_4px_14px_rgba(59,130,246,0.4)] flex-shrink-0"
      >
        NÁVRH ZDARMA
      </Link>
    </nav>
