...
export default function Home() {
  return (
    <main className="min-h-[100dvh] selection:bg-[#3b82f6] selection:text-white relative overflow-clip pb-20 md:pb-0">
      {/* Global subtle ambient breathing glows - Optimized for scroll performance */}
