              ...
              <div className="grid sm:grid-cols-3 gap-6 mb-12 pt-8 border-t border-zinc-800/60">
                {[
                  ...
                  },
                  {
                    ...
                    sub: "Budeme ladit detaily, dokud neřeknete: 'To je přesně ono'.",
                  },
                ].map((g, i) => (
...
export function FinalCTA({
  ...
  return (
    <CtaSection 
      headline="Jste připraveni růst?"
      description="Zavolejte mi nebo napište e-mail a probereme, jak přesně můžu pomoci vašemu podnikání. Grafický návrh připravím ZDARMA."
      buttonText="Zavolat nebo napsat zprávu"
      buttonHref={`tel:${phone.replace(/\s+/g, '')}`}
      phone={phone}
    />
  );
}
